export const en = {
  ...
  'permission.addGuidance': 'Add guidance',
  'permission.guidancePlaceholder': "Tell Claude why you're denying and what to do instead...",
  'permission.denyWithGuidance': 'Deny with guidance',
